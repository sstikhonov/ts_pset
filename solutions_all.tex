...
\begin{solution}{{4.12}}
1. Проверим стационарность $y_t$. Для этого рассмотрим распределения $y_1$:

$$
y_1 = l_0 + b_0 + u_1
$$
$$
y_1 \sim N(l_0 + b_0, \sigma^2)
$$
Аналогичным образом для $y_2$:
$$
y_2 = l_1 + b_1 + u_2 = l_0 + b_0 + \alpha u_1 + b_0 + \beta u_1 + u_2
$$
$$
y_2 \sim N(l_0 + 2 b_0, (1 + \alpha^2 + \beta^2)\sigma^2)
$$
Таким образом, $y_1 \stackrel{d}{=} y_2$, а значит $y_t$ не является стационарным процессом.

2. Запишем $y_{101}$:

$$
y_{101} = l_{100} + b_{100} + u_{101}
$$
$$
\E(y_{101}|I_{100}) = \E(l_{100} + b_{100} + u_{101}|I_{100}) = l_{100} + b_{100} = 22
$$
$$
\Var(y_{101}, I{100}) = \Var(l_{100} + b_{100} + u_{101} | I_{100}) = Var(u_{101}) = 16
$$

В результате, $y_{101}|I_{100} \sim N(22, 16)$, а значит 95\% доверительный интервал имеет вид:
$$
\left[22 - 1.96 \cdot 4, 22 + 1.96 \cdot 4 \right]
$$

Аналогично, запишем $y_{102}$:

$$
y_{102} = l_{101} + b_{101} + u_{102} = l_{100} + b_{100} + \alpha u_{101} + b_{100} + \beta u_{101} + u_{102}
$$
$$
\E(y_{102}|I_{100}) = \E(l_{100} + b_{100} + \alpha u_{101} + b_{100} + \beta u_{101} + u_{102}|I_t) = l_{100} + 2 b_{100} = 20 + 4 = 24
$$
$$
\Var(y_{102}|I_{100}) = \Var(l_{100} + b_{100} + \alpha u_{101} + b_{100} + \beta u_{101} + u_{102}|I_t) = (\alpha+\beta)^2 \cdot 16 + 16 = 20 
$$

Таким образом, $y_{102}|I_{100} \sim N(24, 20)$, а значит 95\% доверительный интервал имеет вид:
$$
\left[24 - 1.96 \cdot \sqrt{20}, 24 + 1.96 \cdot \sqrt{20} \right]
$$
\end{solution}
